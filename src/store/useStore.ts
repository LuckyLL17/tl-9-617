...
import type { User, InsuranceAccount, Transaction, PaymentOrder, ServiceApplication, InsuranceService, ScanRecord, QrCodeStatus } from '@/types';
...
interface StoreState {
  ...
  setQrCodeStatus: (status: QrCodeStatus) => void;
